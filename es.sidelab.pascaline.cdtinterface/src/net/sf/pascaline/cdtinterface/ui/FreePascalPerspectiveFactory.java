...
import net.sf.pascaline.cdtinterface.ui.wizards.PascalWizardRegistry;
...
public class FreePascalPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
		...
		layout.addActionSet(CUIPlugin.SEARCH_ACTION_SET_ID); // This is the
																...
																// toolbar
																// action
		layout.addActionSet("net.sf.pascaline.cdtinterface.FreePascalElementCreationActionSet");
